...
| `/logic-check`        | Red-line review: fatal logic / terminology / grammar only  | Manual only  |
| `/analyze-experiment` | Experimental data to LaTeX analysis paragraph              | Manual only  |
| `/review-paper`       | Strict review of a paper PDF with revision strategy        | Manual only  |
